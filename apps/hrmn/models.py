...
class Person(models.Model):
    ...
    type = models.CharField(max_length=1, choices=TYPE_PERSON, default='C')
    name = models.CharField(max_length=200)
    document_type = models.CharField(max_length=3, choices=TYPE_DOCUMENT, default='DNI')
    ...
    def is_client(self):
        return self.type in ('C', 'B')

    def is_supplier(self):
        return self.type in ('S', 'B')
